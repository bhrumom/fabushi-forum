# Fabushi — forum web platform

Status: repository bootstrap; source migration is pending.

This public repository is the independent home for **forum web platform** in the Fabushi platform repository separation project.

- Project: `FAB-P0013` / `PRS`
- Source baseline: `bhrumom/fabushi@cbe65975f3c4c077fa64af4171ebe3d2900185ad`
- Planned source roots: `forum`
